        ...
        static void Main(string[] args)
        {
           ...
           ingresar números diferentes. */
            ...
            if (numero1 != numero2 && numero2 != numero3 && numero3 != numero1)
            {
                ...
                Console.WriteLine($"Los números ordenados de menor a mayor son: {menor}, {centro}, {mayor}");
            }
            else
            {
                Console.WriteLine("Error: Los números deben ser diferentes.");
            }
            ...
            /*EJERCICIO 6: Realizar la prueba de escritorio para el siguiente algoritmo, según los casos propuestos a 
              continuación. 
                Caso1: finalProm>0 
                Caso2: finalProm=20 
                Caso3: finalProm=15 
